...
название магазина;
логотип;
информацию о ближайшей доставке;
ссылку для перехода на внешний ресурс при клике на карточку магазина.
2. REST API запрос
...
offset	integer	нет	Смещение для пагинации, если список магазинов большой
...
Поле	Тип	Описание
items	array	Список магазинов-партнёров
...
deliveryInfo	object	Информация о ближайшей доставке
...
deliveryInfo.minMinutes	integer	Минимальное время быстрой доставки в минутах
deliveryInfo.maxMinutes	integer	Максимальное время быстрой доставки в минутах
...
Нужно ли отображать только доступные магазины или также недоступные, но в неактивном состоянии?
Откуда определяется город или зона доставки пользователя: из профиля, геолокации, выбранного адреса или query-параметра?
Нужно ли поддерживать сортировку магазинов: по ближайшей доставке, популярности, алфавиту или приоритету партнёра?
Должна ли ссылка открываться во внешнем браузере или во встроенном WebView?
Нужен ли deeplink для возврата пользователя обратно в приложение после перехода на внешний ресурс?
Нужно ли показывать состояние пустого списка, если магазины недоступны в выбранном городе?
Нужна ли пагинация или количество партнёрских магазинов ограничено?
Кто формирует строку displayText: backend или mobile?
Нужно ли локализовать текст доставки на backend или mobile получает только структурированные данные?
Нужно ли кешировать список магазинов на mobile?
Нужно ли передавать дополнительные признаки для аналитики кликов по магазинам?
Нужно ли скрывать магазин, если у него временно нет доступных интервалов доставки?
